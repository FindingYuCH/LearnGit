...
//		[director runWithScene: [IntroLayer scene]];
        [director runWithScene:[TestLayer scene]];
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    AdMoGoSplashAds *splashAds = [[AdMoGoSplashAds alloc] initWithAppKey:@"ffd6064c2cc74da6909a92ab353f675f"
...
#pragma mark -
#pragma mark AdMoGoSplashAdsDelegate
...
/*
 返回芒果自售广告尺寸 可以不实现 不实现默认返回开发者配置广告，并且全屏展示
 */
...
/*
 返回芒果开屏显示类型 可以不实现 不实现默认返回全屏
 SplashAdShowTypeFull  全屏
 SplashAdShowTypeOn    居上
 SplashAdShowTypeUnder 居下
 */
