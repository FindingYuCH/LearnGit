...
@interface RectangleAdViewController ()

@end

@implementation RectangleAdViewController
- (void)viewDidLoad
{
    [super viewDidLoad];
    
    [AdsMOGOContent shareSingleton].title = @"iPad矩形";
    ...
    _rectAd = [[AdMoGoView alloc] initWithAppKey:MoGo_ID_IPad
                                           adType:AdViewTypeRectangle
                               adMoGoViewDelegate:self];
    _rectAd.adWebBrowswerDelegate = self;
    _rectAd.frame = CGRectMake(0.0, 100.0, 0.0, 0.0);
    [self.view addSubview:_rectAd];
    [_rectAd release];
...
- (void)dealloc
{
    _rectAd.adWebBrowswerDelegate = nil;
    _rectAd.delegate = nil;
    [super dealloc];
}
